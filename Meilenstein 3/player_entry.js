...
function onSubmit() {
    ...
    if (trikotnummer.value == null || parseInt(trikotnummer.value) > 15
       || parseInt(trikotnummer.value) < 4 ) {
    ...
    if (jahrgang.value == null || parseInt(jahrgang.value) > 2015
       || parseInt(jahrgang.value) < 0 ) {
